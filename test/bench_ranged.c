...
// B: s3_get_many batch, called twice (1st = cold connections, 2nd = ?)
// C: big single GET (buffer growth cost shows in CPU, not wall time)
#include "../libs3.h"
#include <stdio.h>
#include <stdlib.h>
#include <time.h>
...
int main(void){
    ...
    // B: batched (s3_get_batch) — three rounds (cold vs warm connections)
